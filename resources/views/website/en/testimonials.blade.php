...
<div id="titu">
    <br><br><br>
<h2 style="color: #FFF" align="center">Testimonials</h2>
<h4 align="center">Share travel experiences with us</h4>
</div>
          ...
          <div class="col-sm-8">
            <center>
              <?php
                ...
                $meses = array("January","February","March","April","May","June","July","August","Septebmber","October","November","December");
              ?>
                     ...
                     <?php $url = Request::path();?>
                      ...
                      <div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                            <div class="form-group">
                              <input type="text" name="nationality" class="form-control" placeholder="Nationality" required style="border: 2px solid #e6e6e6;">
                            </div>
                          </div>
                            <div class="col-sm-6">
                                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <textarea name="testimonial" id="testimonial" class="form-control" rows="4" placeholder="Enter your testimony" style="border: 2px solid #e6e6e6;" required></textarea>
                        </div>
                        <div class="form-group">
