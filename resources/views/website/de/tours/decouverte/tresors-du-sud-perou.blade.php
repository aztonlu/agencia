...
<div class="trip-detail">
    <div class="container">
        ...
        <div class="col-md-9 tab-wrap">
            ...
            <div class="tab-content paper-effect">
                <div class="tab-pane active" id="itenary">
                    ...
                    <h4>ENDE UNSERER DIENSTLEISTUNGEN</h4>
        ...
        <div class="col-md-3 tab-wrap tab-wrap-aside" style="margin-top: 0;">
            ...
            <div class="resume">
                <small>Von:</small><span class="pd price-cat"><i class="icon-money"></i> USD {{ $tours[0]->price}}</span>
            </div>
            <div class="resume">
                <small>Tage:</small><span class="pd days"><i class="icon-sun"></i>{{ $tours[0]->days}} T / <i class="icon-moon"></i>{{ $tours[0]->days - 1}} N</span>
            </div>
            <div class="content-buy">
                <div class="content-categories">
                    <div class="categories"><i class="icon-mountain"></i> <strong>Höhe:</strong></div><div class="categorie-detail"> 4500 msnm</div>
                    <div class="categories"><i class="icon-shoe"></i> <strong>Ebene:</strong></div><div class="categorie-detail"> {{ $tours[0]->difficulty }}</div>
                    <div class="categories"><i class="icon-backpack"></i> <strong>Kategorie:</strong></div><div class="categorie-detail"> {{ $tours[0]->category }}</div>
                    
                </div>
                <button class="btn btn-primary" data-toggle="modal" data-target="#myModal">BUCHEN</button><button class="btn btn-info" data-toggle="modal" data-target="#favoritesModal"><span class="icon-chat"></span>Mehr Informationen</button>
            </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Jetzt reservieren</h4>
            </div>
                    ...
                    <form action="{{ url('') }}/storeReservation" method="POST">   
                        ...
                        <div class="form-wrap-two">  
                            <div class="form-group">
                                <label>Namen</label>
                                <input type="text" class="form-control" name="name" placeholder="Gib deinen Namen ein" value="">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="phone" placeholder="Telefonnummer" value="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nationality" placeholder="Land" value="">
                            </div>
                            <div class="form-group">
                                <label>Dauer</label>
                                <div class="row">
                        ...
                        <div class="form-wrap-two">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type">
                                        <option value="Vacance">Vakanz</option>
                                        <option value="Voyage de noces">Flitterwochen</option>
                                        <option value="Voyage team building">Teambildungsreise</option>
                                ...
                                <div class="form-group">
                                    <label>Sie wollen die Dienste eines Leitfadens </label>
                                    <div class="row">
                                ...
                                <div class="form-group">
                                    <label>Du willst mehr</label>
                                    <select class="form-control" name="plus">
                                        <option value="Voyage regroupant les incontournables du pays">Reise Gruppierung der Must-Haves des Landes</option>
                                        <option value="Voyage aventure">Abenteuerreise</option>
                                        <option value="Voyage Communauté">Reisegemeinschaft</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label>Beschreibe deine Reise</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        id="favoritesModalLabel">Stellen Sie eine Frage</h3>
      </div>
             ...
             <div class="modal-body"> 
                        <form action="{{ url('') }}/sendComment" method="POST">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <div class="col-sm-8"><label>Vorname</label>
                                <input type="text" name="nameUser" class="form-control"  placeholder="Gib deinen Namen ein" value="" required >
                            ...
                            <div class="form-group">
                                <div class="col-sm-8"><label>Frage</label>
                                <textarea class="form-control" name="comment" placeholder="Schreibe deine Fragen zu dieser Reise" required></textarea></div>
                            </div>
                            <br><br><br>
                            <button class="btn btn-primary hvr-sweep-to-right">Senden Sie Ihre Fragen</button>
