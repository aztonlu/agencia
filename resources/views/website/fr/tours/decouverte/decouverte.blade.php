                                ...
                                <form class="sidebar sort" action="{{ url('') }}/filterTours" method="get">
                                    <div class="form-group">
                                        ...
                                        <div class="icono">
                                         ...
                                         @if($tour_category == "Discover")
                                        <img src="{{url('')}}/img/aven1.gif" height="30%" width="50%" class="img-circle" >
                                        
                                        
                                        @elseif($tour_category == "Aventure")
                                        <img src="{{url('')}}/img/des1.gif" height="30%" width="50%" class="img-circle">
                                        ...
                                        @elseif($tour_category == "High-Mountain")
                                        <img src="{{url('')}}/img/Altamon1.gif" height="30%" width="50%" class="img-circle">
