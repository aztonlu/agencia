...
<div id="titu">
    <br><br><br>
<h2 style="color: #FFF" align="center">Testimonios</h2>
<h4 align="center">Comparta sus experiencias con nosotros</h4>
</div> 
                      ...
                      <div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                          <div class="col-sm-6">
                            <div class="form-group">
                              <input type="text" name="name" class="form-control" placeholder="Nombre" required style="border: 2px solid #e6e6e6;">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                            ...
                            <div class="col-sm-6">
                            <div class="form-group">
                              <input type="text" name="nationality" class="form-control" placeholder="Nacionalidad" required style="border: 2px solid #e6e6e6;">
                            </div>
                          </div>
                            <div class="col-sm-6">
                                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <button type="" class="btn-submit">Enviar testimonio</button>
                        </div>
                      </form>
              </div>
            </div>
