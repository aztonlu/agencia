      ...
      <div class="row" style="text-align: center; color: white;">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-3">
                   <a href="{{url('')}}/es/tours/decouverte/Discover"><h4>Descubrir</h4></a><br>
              <a href="{{url('')}}/es/tours/decouverte/Discover"><img src="{{url('')}}/img/Aventura.jpg" height="60%" width="60%"> 
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3">
                  <a href="{{url('')}}/es/tours/decouverte/High-Mountain"><h4>Alta montaña</h4></a>
            <a href="{{url('')}}/es/tours/decouverte/High-Mountain"><img src="{{url('')}}/images/Alta_montaña.jpg" height="60%" width="60%" class="img-circle"></a>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3">
                  <a href="{{url('')}}/es/tours/decouverte/Aventure"><h4>Aventura</h4></a><br>
              <a href="{{url('')}}/es/tours/decouverte/Aventure"><img src="{{url('')}}/images/Descubir.jpg" height="60%" width="60%" class="img-circle"></a>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3">
                <a href="{{url('')}}/es/tours/decouverte/Excursions"><h4>Excursiones</h4></a><br>
                <a href="{{url('')}}/es/tours/decouverte/Excursions"><img src="{{url('')}}/images/Excursiones2.jpg" height="60%" width="60%" class="img-circle"></a>
            </div>
        </div>
    </div>
     <div class="col-xs-12 col-md-4">
            ...
            <h5 style="color: #fff;">Suscribase para recibir noticias y ofertas</h5>
            ...
            {{ csrf_field() }}
              ...
              <button type="submit" class="btn-submit text-center" style="width:90%">Suscribase</button>
