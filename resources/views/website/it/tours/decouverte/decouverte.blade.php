    	...
    	<div class="container">
                                ...
                                <form class="sidebar sort" action="{{ url('') }}/filterTours" method="get">
                                    <div class="form-group">
                                        ...
                                        @endif
                                            ...
                                            <br><br>
                                        <label><strong>Le Categorie</strong></label>
                                        <select class="form-control selectpicker" name="category">
                                            <option value="Discover">Scoperta</option>
                                            <option value="Adventure">Avventura</option>
                                            <option value="Excursions">Excursions</option>
                                            <option value="High Mountain">Alta montagna</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker" name="difficult">
                                            ...
                                            <option value="Very Difficult">Molto Difficile</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label><strong>Prezzo <em>(in USD)</em></strong></label>
                                    ...
                                    <button class="btn btn-search btn-primary hvr-sweep-to-right col-sm-12" type="submit">Cerca</button>
            ...
            @foreach($tours as $tour)
    			<div class="item-list">
                        ...
                        <div class="col-sm-5">
        					<div class="item-img row" style="background-image: url('{{url('')}}/{{  $tour->coverpage}}');">
        						<div class="item-overlay">
                                            ...
                                            <a href="{{url('')}}/it/tourshow/{{ $tour->id }}"><span class="icon-hiking"></a>  
        				...
        				<div class="col-sm-7">
        					<div class="item-desc">
                                <h5 class="item-title"><a href="{{url('')}}/it/tourshow/{{ $tour->id }}">{{ $tour->title}}</h5></a>
        						<div class="sub-title">
        							Perú
        						</div>
        						<div class="item-excerpt">{{ $tour->summary}}</div>

        						<div class="left"><span class="icon-calendar"></span> {{ $tour->days}} Giorni / {{ $tour->days -1}} Notti</div>
        						<div class="right">
        					...
        					<div class="item-book">
                                    ...
                                    <a href="{{url('')}}/it/tourshow/{{ $tour->id }}" class="btn btn-primary hvr-sweep-to-right">Prenota</a>
