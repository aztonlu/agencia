@extends('website.partials.it.maintre')
    ...
    <div class="container">
        ...
        <div class="col-md-9 tab-wrap">
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active"><a href="#itenary">Percorso</a></li>
                <li class=""><a href="#overview">Organizzazione</a></li>
            </ul>
        ...
        <div class="col-md-3 tab-wrap tab-wrap-aside" style="margin-top: 0;">
            ...
            <div class="resume">
                <small>To-Da:</small><span class="pd price-cat"><i class="icon-money"></i> USD {{ $tours[0]->price}}</span>
            </div>
            <div class="resume">
                <small>Giorni:</small><span class="pd days"><i class="icon-sun"></i>{{ $tours[0]->days}} G / <i class="icon-moon"></i>{{ $tours[0]->days - 1}} N</span>
            </div>
            <div class="content-buy">
                <div class="content-categories">
                    <div class="categories"><i class="icon-mountain"></i> <strong>Altitudine:</strong></div><div class="categorie-detail"> 4500 msnm</div>
                    <div class="categories"><i class="icon-shoe"></i> <strong>Livello:</strong></div><div class="categorie-detail"> {{ $tours[0]->difficulty }}</div>
                    <div class="categories"><i class="icon-backpack"></i> <strong>Categoria:</strong></div><div class="categorie-detail"> {{ $tours[0]->category }}</div>
                    
                </div>
                <button class="btn btn-primary" data-toggle="modal" data-target="#myModal">PRENOTARE</button><button class="btn btn-info" data-toggle="modal" data-target="#favoritesModal"><span class="icon-chat"></span>Ulteriori Informazioni</button>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="preview-wrap">
                    ...
                    <div class="form-wrap">
                        <h4 class="text-center">Scegli il metodo di pagamento:</h4>
                    ...
                    <form action="{{ url('') }}/storeReservation" method="POST">   
                        ...
                        <div class="form-wrap-two">  
                            <div class="form-group">
                                <label>Nome</label>
                                <input type="text" class="form-control" name="name" placeholder="Inserisci il tuo nome" value="">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" class="form-control" name="email" placeholder="Indirizzo e-mail" value="">
                            </div>
                            <div class="form-group">
                                <label>Telefono</label>
                                <input type="text" class="form-control" name="phone" placeholder="Numero di telefono" value="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nationality" placeholder="Paese" value="">
                            </div>
                            <div class="form-group">
                                <label>Durata</label>
                                <div class="row">
                        ...
                        <div class="form-wrap-two">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type">
                                        <option value="Vacance">Posto vacante</option>
                                        <option value="Voyage de noces">Luna di miele</option>
                                        <option value="Voyage team building">Viaggio di squadra</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="hostel">
                                        <option value="Maison Habitante">Casa Abitante</option>
                                ...
                                <div class="form-group">
                                    <label>Volete i servizi di una guida </label>
                                    <div class="row">
                                        <div class="col-sm-4"><input type="radio" name="guide" value="Francophone"> <small>Francofono</small></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="plus">
                                        <option value="Voyage regroupant les incontournables du pays">Viaggiare raggruppando i must-haves del paese</option>
                                        <option value="Voyage aventure">Avventura viaggio</option>
                                        <option value="Voyage Communauté">Comunità di viaggi</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label>Descrivi il tuo viaggio</label>
                                    <textarea name="message" rows="5" class="form-control"></textarea>
                                </div>
                                <button class="btn btn-primary hvr-sweep-to-right" type="submit">Riserva</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        id="favoritesModalLabel">Fai una domanda</h3>
      </div>
             ...
             <div class="modal-body"> 
                        <form action="{{ url('') }}/sendComment" method="POST">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <div class="col-sm-8"><label>Conome</label>
                                <input type="text" name="nameUser" class="form-control"  placeholder="Inserisci il tuo nome" value="" required >
                            ...
                            <div class="form-group">
                                <div class="col-sm-8"><label>Domanda</label>
                                <textarea class="form-control" name="comment" placeholder="Scrivi le tue domande su questo viaggio" required></textarea></div>
                            </div>
                            <br><br><br>
                            <button class="btn btn-primary hvr-sweep-to-right">Invia le tue domande</button>
