                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($blogs as $blog)
                                    <tr>
                                        ...
                                        <td>&nbsp;&nbsp;&nbsp; <a href="{{url('')}}/publicidad/{{$blog->id}}/blog" onclick="return confirm('¿Estas seguro de querer enviar el blog a todos los correos suscritos?')" style="color:#ff7677;"><span class="fa fa-envelope-o"></span></a></td>
                                        <td>{{$blog->link}}</td>
