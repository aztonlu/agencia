                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-10">
                                    {!! Form::email('email', null, ['class' => 'form-control', 'placeholder' => 'ejemplo@agencia.com', 'required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::select('language', ['spanish' => 'Spanish', 'english' => 'English', 'italian' => 'Italian', 'french' => 'French', 'german' => 'German'], null, ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            <div class="form-group">
