...
//nuevo
    ...
    public function updateGallery(Request $request)
    {
        ...
        if(!is_null($file))
        {
            ...
            $img = Image::make($request->file('journalImage')->getRealPath()); 
             $img->save('/home/terres1/public_html/tours/mIYvpkzMUkwb35E.png');
           /* $nombreJournal = trim($imagexBorrar);
            $image = Image::make($file->getRealPath())->resize(825, 619);
            $image->save('/home/terres1/public_html/'.$nombreJournal);
            chmod($imagexBorrar, 0777);
            /*$exitCode = Artisan::call('cache:clear');
            shell_exec($exitCode);*/
